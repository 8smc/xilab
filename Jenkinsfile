        ...
        stages {
          ...
          stage('build-unix') {
            ...
            steps {
              ...
              sh "curl -Ss -o ximc-0.0.tar.gz http://files.xisupport.com/libximc_alpha/libximc-${LIBXIMC_VERSION}-all.tar.gz"
          ...
          stage('build-win') {
            ...
            steps {
              ...
              // Fetch libximc artifact, any local filename is okay
              powershell "Invoke-WebRequest -Uri http://files.xisupport.com/libximc_alpha/libximc-${LIBXIMC_VERSION}-all.tar.gz -OutFile ximc-0.0.tar.gz"
